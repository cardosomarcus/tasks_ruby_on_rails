class AtividadesController < ApplicationController
  ...
  # GET /atividades.json
  def index
    @atividades = Atividade.order :status
  end
  ...
  def create
    ...
    respond_to do |format|
      if @atividade.save
        format.html { redirect_to atividades_path, notice: 'Tarefa criada!' }
  ...
  def update
    respond_to do |format|
      if @atividade.update(atividade_params)
        format.html { redirect_to @atividade, notice: 'Tarefa atualizada!' }
  ...
  def destroy
    @atividade.destroy
    respond_to do |format|
      format.html { redirect_to atividades_url, notice: 'Tarefa excluída!' }
  ...
  private
    ...
    def atividade_params
      params.require(:atividade).permit(:descricao, :status)
    end
end
